export default {
  ...
  opc: {
    ...
    fins: {
      title: 'FINS Security',
      emptyDesc: 'FINS Security Module',
      describe: 'Configure Omron FINS protocol filtering rules with command blacklist and memory area control',
      addRule: 'Add Rule',
      groupName: 'User Group',
      groupNamePlaceholder: 'Enter user group name',
      groupNameRequired: 'Please enter user group name',
      ...
      disabled: 'Disabled',
      ruleSwitch: 'Rule Switch',
      cmdFilter: 'Command Blacklist',
      cmdFilterPlaceholder: 'Select or enter commands',
      memoryFilter: 'Memory Area Filter',
      config: 'Config',
      area: 'Area',
      address: 'Address',
      length: 'Length',
      areaPlaceholder: 'Select Area',
      addMemory: 'Add Memory Config',
      memoryConfigTitle: 'Memory Area Configuration',
      viewDetail: 'View Details',
      actions: 'Actions',
      view: 'View',
      edit: 'Edit',
