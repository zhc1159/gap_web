export default {
  ...
  login: {
    ...
    featureSecurityDesc: '多层安全策略实时保障',
    featureMonitor: '实时监控',
    featureMonitorDesc: '全方位流量态势感知',
    featureIsolation: '物理隔离',
    featureIsolationDesc: '内外网安全隔离传输',
    featureManage: '智能管理',
    featureManageDesc: '便捷高效的配置管理',
    ad1Title: '新一代安全隔离技术',
    ad1Desc: '采用国际领先的物理隔离架构，确保数据单向安全传输',
    ad2Title: '全面威胁感知能力',
    ad2Desc: '实时深度包检测，智能识别并拦截各类网络攻击',
    ad3Title: '高效数据同步引擎',
    ad3Desc: '支持多种协议的跨网段数据安全同步，零丢包传输',
    ad4Title: '灵活的策略管理平台',
    ad4Desc: '可视化策略配置，支持细粒度访问控制与审计追踪',
    adContact: '联系人',
    adPhone: '电话',
    adEmail: '邮箱',
    adAddress: '地址'
