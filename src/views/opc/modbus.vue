    ...
    <div class="content-wrapper">
      <div class="card main-card">
        <div class="card-content">
          <!-- 数据表格 -->
          <el-table :data="tableData" v-loading="loading" class="modbus-table">
            <!-- 用户组 -->
            ...
            <!-- 操作 -->
            <el-table-column :label="$t('opc.modbus.actions')" width="220" fixed="right">
              <template #default="{ row }">
      ...
      <el-form :model="formData" :rules="formRules" ref="formRef" label-width="120px" class="form-content">
        <el-form-item :label="$t('opc.modbus.groupName')" prop="groupName">
          <el-input
            ...
            :placeholder="$t('opc.modbus.groupNamePlaceholder')"
            maxlength="31"
            show-word-limit
          />
        </el-form-item>
