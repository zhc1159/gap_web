    ...
    <div class="content-wrapper">
      <div class="card main-card">
        <div class="card-content">
          <!-- 数据表格 -->
          <el-table :data="tableData" v-loading="loading" class="hartip-table">
            <!-- 用户组 -->
            ...
            <!-- 操作 -->
            <el-table-column :label="$t('opc.hartip.actions')" width="220" fixed="right">
              <template #default="{ row }">
      ...
      <el-form :model="formData" :rules="formRules" ref="formRef" label-width="130px" class="form-content">
        <el-form-item :label="$t('opc.hartip.groupName')" prop="group_name">
          <el-input
            ...
            :placeholder="$t('opc.hartip.groupNamePlaceholder')"
            maxlength="31"
            show-word-limit
          />
        </el-form-item>
