<template>
  <div class="page-container">
    <div class="page-card">
      <div class="page-describe">{{ $t('audit.gapLog.describe') }}</div>
      <div class="page-util">
        <el-form :model="filterForm" inline class="form-label">
          ...
          <el-form-item>
            ...
            <el-tooltip
              :content="$t('audit.gapLog.exportAllOnly')"
              placement="top"
              effect="dark"
            >
      ...
      <div class="page-table">
        ...
        >
          ...
          <el-table-column prop="region" :label="$t('audit.gapLog.region')" width="100">
          ...
          <el-table-column prop="user" :label="$t('audit.gapLog.user')" width="120" />
          <el-table-column prop="result" :label="$t('audit.gapLog.result')" width="100">
            <template #default="{ row }">
          ...
          <el-table-column prop="describe" :label="$t('audit.gapLog.description')" min-width="200" show-overflow-tooltip />
          <el-table-column prop="failReason" :label="$t('audit.gapLog.failReason')" min-width="150" show-overflow-tooltip />
        </el-table>
...
const fetchData = async () => {
  ...
  try {
    ...
    tableData.value = [
      ...
      {
        id: '2',
        date: '2026-04-07 10:28:42',
        sip: '192.168.1.101',
        region: 'external',
        user: 'operator',
        result: false,
        describe: 'Configuration change failed',
        failReason: 'Permission denied'
      },
      {
        id: '3',
        date: '2026-04-07 10:25:33',
        sip: '192.168.1.102',
        region: 'internal',
        user: 'admin',
        result: true,
        describe: 'System configuration updated',
        failReason: ''
      },
      {
        id: '4',
        date: '2026-04-07 10:20:18',
        sip: '10.0.0.50',
        region: 'external',
        user: 'guest',
        result: false,
      ...
      {
        id: '5',
        date: '2026-04-07 10:15:05',
        sip: '192.168.1.103',
        region: 'internal',
        user: 'operator',
        result: true,
        describe: 'File sync initiated',
        failReason: ''
      }
    ]
